...
- Next.js 코드를 Figma가 직접 읽을 수는 없어서, `docs/figma-import-spec.json`을 중간 포맷으로 사용합니다.
...
## Figma에서 쓰는 방식
1. `docs/figma-import-spec.json`을 읽는 커스텀 플러그인 또는 스크립트를 사용합니다.
